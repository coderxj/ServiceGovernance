...
public class MachineInfoParam implements org.apache.thrift.TBase<MachineInfoParam, MachineInfoParam._Fields>, java.io.Serializable, Cloneable, Comparable<MachineInfoParam> {
  ...
  public java.util.List<MachineInfo> params; // required
  ...
  public MachineInfoParam(
    ...
    java.util.List<MachineInfo> params)
  {
    this();
    this.appKey = appKey;
    this.params = params;
  ...
  public MachineInfoParam(MachineInfoParam other) {
    ...
    if (other.isSetParams()) {
      java.util.List<MachineInfo> __this__params = new java.util.ArrayList<MachineInfo>(other.params.size());
      for (MachineInfo other_element : other.params) {
        __this__params.add(new MachineInfo(other_element));
      }
  ...
  public java.util.Iterator<MachineInfo> getParamsIterator() {
    return (this.params == null) ? null : this.params.iterator();
  }

  public void addToParams(MachineInfo elem) {
    if (this.params == null) {
      this.params = new java.util.ArrayList<MachineInfo>();
    }
    this.params.add(elem);
  }

  public java.util.List<MachineInfo> getParams() {
    return this.params;
  }

  public MachineInfoParam setParams(java.util.List<MachineInfo> params) {
    this.params = params;
    return this;
  }
  ...
  public void setFieldValue(_Fields field, java.lang.Object value) {
    ...
    case PARAMS:
      if (value == null) {
        ...
        setParams((java.util.List<MachineInfo>)value);
      }
      break;
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.params = new java.util.ArrayList<MachineInfo>(_list8.size);
                MachineInfo _elem9;
                for (int _i10 = 0; _i10 < _list8.size; ++_i10)
                {
                  _elem9 = new MachineInfo();
                  _elem9.read(iprot);
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, MachineInfoParam struct) throws org.apache.thrift.TException {
      ...
      if (struct.params != null) {
        oprot.writeFieldBegin(PARAMS_FIELD_DESC);
        {
          ...
          for (MachineInfo _iter11 : struct.params)
          {
            _iter11.write(oprot);
          }
          oprot.writeListEnd();
      ...
      if (struct.isSetParams()) {
        {
          ...
          for (MachineInfo _iter12 : struct.params)
          {
            _iter12.write(oprot);
          }
        }
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.params = new java.util.ArrayList<MachineInfo>(_list13.size);
          MachineInfo _elem14;
          for (int _i15 = 0; _i15 < _list13.size; ++_i15)
          {
            _elem14 = new MachineInfo();
            _elem14.read(iprot);
